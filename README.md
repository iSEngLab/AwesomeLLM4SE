...
27. 🔥CodeTree: Agent-guided Tree Search for Code Generation with Large Language Models [2024-arXiv]
...
75. Hierarchical Context Pruning: Optimizing Real-World Code Completion with Repository-Level Pretrained Code LLMs [2024-arXiv]
...
6. ClassEval: A Manually-Crafted Benchmark for Evaluating LLMs on Class-level Code Generation [2024-ICSE]
7. UniTSyn: A Large-Scale Dataset Capable of Enhancing the Prowess of Large Language Models for Program Testing [2024-ISSTA]
8. APPS: Measuring Coding Challenge Competence With APPS [2021-NeurIPS]
9. Competition-Level Code Generation with AlphaCode [2023-Science]
